...
%	\color{red}
	...
	Timing properties of the measured and simulated signals have been studied using digital processing algorithms.
	The influence of the key parameters of the detector on the signal shape are understood.
}
%
\maketitle
%
