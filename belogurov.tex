...
%	\color{red}
	...
	In order to study the characteristics of the detector, it's prototype have been tested.
	This work is dedicated to the study of formation mechanisms of the signals obtained from the NeuRad detector prototype.
	Timing properties of the measured and simulated pulse shapes have been studied using digital processing algorithms.
